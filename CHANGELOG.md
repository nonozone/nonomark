...
- Use the optional caption as the image `alt` text and remove gallery-specific table styling.
- Preserve the gallery picker, ordering controls, host callbacks and 2–4 image workflow.
